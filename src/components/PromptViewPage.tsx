      ...
      footer={
        <div className="flex w-full flex-wrap items-center justify-between gap-2">
          <div className="flex min-w-0 items-center gap-2">
            ...
            {isActiveHere === true ? (
              <span
                className="inline-flex shrink-0 items-center rounded border border-primary/30 bg-primary/10 px-2 py-1 text-[11px] font-medium text-primary"
              ...
              {menuOpen ? (
                <>
                  ...
                  <div
                    ...
                    ref={menuRef}
                    role="menu"
                    className="absolute bottom-full right-0 mb-2 w-52 overflow-hidden rounded-md border border-border bg-card py-1 shadow-lg"
                    style={{ zIndex: 30 }}
                    onKeyDown={(event) => {
