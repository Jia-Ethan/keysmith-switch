  ...
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-2 rounded-lg border border-border bg-card px-3 py-2">
      ...
      {supportedScopes.length > 1 ? (
        ...
        <span
          className="inline-flex h-7 items-center rounded-md border border-border bg-muted px-2 text-[12px] font-medium text-foreground"
      ...
      {projectMissing ? (
        <p className="w-full text-[11px] text-amber-600 dark:text-amber-500" data-testid="scope-project-required">
