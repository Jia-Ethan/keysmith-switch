  ...
  render(): React.ReactNode {
    ...
    return (
      <main className="flex min-h-full items-center justify-center bg-background p-6 text-foreground">
        <section role="alert" className="w-full max-w-md space-y-4 rounded-2xl border border-border bg-card p-6 shadow-sm">
          <h1 className="text-[20px] font-semibold">界面遇到了问题</h1>
