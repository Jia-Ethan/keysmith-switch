    ...
    <div className="rounded-lg border border-border bg-card">
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 px-3 py-2">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <h1 className="truncate text-[13px] font-semibold text-foreground">{toolInfo.name}</h1>
        </div>
      ...
      {recovery ? (
        <p
          className="flex items-start gap-2 border-t border-border bg-amber-500/10 px-3 py-2 text-[12px] text-amber-700 dark:text-amber-400"
