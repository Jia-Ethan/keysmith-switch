      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-border px-4 py-3">
        <div className="flex min-w-0 flex-1 items-center gap-2">
          ...
          {!creating && isActiveHere === true ? (
            <span
              className="inline-flex shrink-0 items-center rounded-lg border border-primary/30 bg-primary/10 px-2 py-0.5 text-[13px] font-medium text-primary"
    ...
    <div className="relative">
      ...
      {open ? (
        <>
          ...
          <div
            role="menu"
            className="absolute right-0 top-10 z-30 w-52 overflow-hidden rounded-xl border border-border bg-card py-1 shadow-lg"
          >
            <MenuItem
